...
<html lang="en">
    ...
    <body>
        <div id="page" class="latest-version image-bg pattern-bg fixed" data-background="img/sections/page-bg.png">
            <!-- Page Loader -->
            <div id="pageloader">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-3 widget bottom-xs-pad-20">
                                ...
                                <!-- Address -->
                                <p>
									Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, consectetur adipiscing elit. Vestibulum nec odio ipsum. Suspendisse cursus malesuada facilisis.
								<p>
                                ...
                                <div class="widget-title">
                                    ...
                                    <nav>
                                        <ul class="widget-post">
                                            <li class="clearfix">
                                                <a href="#" class="post-img"><img src="img/sections/blog/popular/1.jpg" class="img-responsive" width="75" height="75"></img></a>
                                                <h6><a href="#">A model blog post title</a></h6>
                                                <p>June,15 2015</p>
                                            </li>
                                            <li class="clearfix">
                                                <a href="#" class="post-img"><img src="img/sections/blog/popular/2.jpg" class="img-responsive" width="75" height="75"></img></a>
                                                <h6><a href="#">A model blog post title</a></h6>
                                                <p>June,15 2015</p>
                                            </li>
                                        </ul>
                ...
                <div class="copyright">
                    <div class="container">
                        <div class="row text-center">
                            <!-- Copyrights -->
                            <div class="col-md-12">
                                Copyright &copy; zozothemes.com., 2015
                                <br />
                                <!-- Terms Link -->
